...
# - return attn masks in encoder + decoder
...
class Transformer(Module):
    ...
    def forward(self, src: Tensor, tgt: Tensor, src_mask: Optional[Tensor] = None, tgt_mask: Optional[Tensor] = None,
        ...
        memory, encoder_attns = self.encoder(src, mask=src_mask, src_key_padding_mask=src_key_padding_mask)
        output, decoder_attns, cross_attns = self.decoder(tgt, memory, tgt_mask=tgt_mask, memory_mask=memory_mask,
                              tgt_key_padding_mask=tgt_key_padding_mask,
                              memory_key_padding_mask=memory_key_padding_mask)
        return output, encoder_attns, decoder_attns, cross_attns
...
class TransformerEncoder(Module):
    ...
    def forward(self, src: Tensor, mask: Optional[Tensor] = None, src_key_padding_mask: Optional[Tensor] = None) -> Tensor:
        ...
        return output, torch.stack(attns)
...
class TransformerDecoder(Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None,
        ...
        for mod in self.layers:
            output, attn, cross_attn = mod(output, memory, tgt_mask=tgt_mask,
        ...
        return output, torch.stack(attns), torch.stack(cross_attns)
