...
cfg = CN(
    {
        ...
        "optimize": {
            "optimizer": "adamW",
            "grad_clip": 100.0,
            "actor": {"weight_decay": 1e-2, "eps": 1e-6, "lr": 1e-4},
            "value": {"weight_decay": 1e-2, "eps": 1e-6, "lr": 1e-4},
            "model": {"weight_decay": 1e-2, "eps": 1e-6, "lr": 1e-4},
            "goal_vae": {"weight_decay": 1e-2, "eps": 1e-6, "lr": 1e-4},
            "mgr_actor": {"weight_decay": 1e-2, "eps": 1e-6, "lr": 1e-4},
            "mgr_value": {"weight_decay": 1e-2, "eps": 1e-6, "lr": 1e-4},
            "reward_scale": 1.0,
            "discount_scale": 5.0,
